      ...
      <div className="w-full max-w-sm space-y-6 rounded-lg border border-border bg-card p-8 shadow-sm">
        ...
        <div className="space-y-3">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-md border border-input bg-secondary px-4 py-2.5 text-sm font-medium text-secondary-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
          >
